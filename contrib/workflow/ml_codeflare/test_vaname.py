...
edges = pipeline.get_dag().get_edges()
for edge in edges:
    print(f"\nfrom_node_name: {edge[0].get_name()} virtual actor name: {edge[0].get_vaname()}")
    print(f"to_node_name: {edge[1].get_name()} virtual actor name: {edge[1].get_vaname()}")
